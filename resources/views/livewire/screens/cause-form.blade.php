<form form wire:submit.prevent="submit" class="flex flex-col flex-grow justify-between min-h-body overflow-hidden py-4">
    ...
    <x-progress-bar value="80" currentvalue="4" totalvalue="5" class="mb-10 mt-3"/>

        <h1 class="text-4xl font-bold mb-4 text--primary pt-8">What causes are most important to you?</h1>
        ...
        <div class="mt-2">
            ...
            @foreach($options as $value => $option)
                <x-checkbox-card
                    ...
                    class="rounded-lg flex justify-center text-center items-center py-4 px-2 font-bold">
                        {{$option}}
                </x-checkbox-card>
            @endforeach
    ...
    <x-analytics-tracker page="profile-cause" />
</form>
