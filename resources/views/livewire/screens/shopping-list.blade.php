<form form wire:submit.prevent="submit" class="flex flex-col flex-grow justify-between min-h-body overflow-hidden py-4">
    ...
    <x-progress-bar value="40" currentvalue="2" totalvalue="5" class="mb-10 mt-3"/>

        <h1 class="text-4xl font-bold mb-4 text--primary pt-8">What's on your typical shopping list?</h1>
    ...
    <x-analytics-tracker page="shopping-list" />
</form>
